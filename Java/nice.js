...
const Plot = class {
	...
	init(width, height, xlabel, ylabel, title, callback=null){
		var plt = this;
		plt.include_d3(function(){
			plt.empty_chart(xlabel,ylabel, title, callback);
		});
		this.width = width;
		this.height = height;
	}
	...
	empty_chart(xlabel,ylabel,title, callback=null){
		...
		this.w = (+this.svg.attr("width")) -120;
	...
	letters(data, letter, color=null, colorOffset=0, alpha=1){
